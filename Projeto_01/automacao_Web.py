...
# Caso o navegador já esteja fixo na barra de tarefas -> winleft, posição do navegador
...
# Copia o link da variável drive_BD onde consta a base de dados
pyperclip.copy(drive_BD)
# Cola o link (Esse procedimento garante que o programa não terá problemas com caracteres especiais)
pyautogui.hotkey("ctrl", "v")
pyautogui.press("enter")

# Baixando a base de dados

# Pausa para que o site abra completamente, ajuste conforme performance do computador
time.sleep(3)
...
# Importa o arquivo para a variável tabela
tabela = pd.read_excel(r"C:\Users\Vinicius\Desktop\Vendas - Dez.xlsx")
...
time.sleep(3.5)
# Copia o endereço de email para onde o relatório será enviado (armazenado na variável email_Diretoria). Atenção extra para casos onde é necessário enviar para mais de um email.
pyperclip.copy(email_Diretoria)
pyautogui.hotkey("ctrl", "v")
